        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="flex gap-1 w-full">
                ...
                <div class="w-1/2">
                    ...
                    <input type="number" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" id="constraint" placeholder="Enter constraint">
                </div>
            </div>
        </div>
